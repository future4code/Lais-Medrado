...
function checaTriangulo(a, b, c) {
  const ladosIguais3 = "Equilátero"
  const ladosIguais2= "Isósceles"
  const ladosIguais0 = "Escaleno"
...
novaArray [ posicaoArray] = item
arrayExercicio10 = [novaArray [ novaArray.length -2], novaArray[1]]
}
return (arrayExercicio10) 
